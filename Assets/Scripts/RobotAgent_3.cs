...
public class RobotAgent_3 : Agent
{
    ...
    void Awake()
    {
        obsSideChannel = new ObsSideChannel_3();
...
//        randomGoalZ = -3.45f;
    ...
    public void MoveAgent(float act0, float act1, float act_forward)
    {
        var dirToGo = Vector3.zero;
        var rotateDir = Vector3.zero;
        dirToGo = transform.forward * 0.03f * act_forward + transform.up * act0 * 0.02f;
